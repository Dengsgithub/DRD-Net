...
def get_args():
    ...
    parser.add_argument("--image_dir_rain", type=str, default='dataset/200L/test/Rain100L',
                        help="rain image dir")
    parser.add_argument("--image_dir_gt", type=str, default='dataset/200L/test/noRain100L',
                        help="gt image dir")
