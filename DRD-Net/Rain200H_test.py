...
def get_args():
    ...
    parser.add_argument("--image_dir_rain", type=str, default='dataset/200H/Rain_H/test/x_in',
                        help="rain image dir")
    parser.add_argument("--image_dir_gt", type=str, default='dataset/200H/Rain_H/test/y_out',
                        help="gt image dir")
    parser.add_argument("--model", type=str, default="the_end",
                        help="model architecture ")
    parser.add_argument("--weight_file", type=str, default='./weights/rain200H/weights.106-0.002-28.16601.hdf5',
